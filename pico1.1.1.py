...
for pin in pins:
    dict[pin] = Pin(pin,Pin.OUT)
stimulusPinIn = Pin(1,Pin.IN)
rewardwinPinOut = Pin(0,Pin.OUT)
...
def runTrial():
  ...
  if goTrial:
    stimDir1(0.5)
    rewardwinPinOut.value(1)
    utime.sleep(1) 
    rewardwinPinOut.value(0)
    utime.sleep(3)
  else:
    stimDir2(0.5)
    utime.sleep(5)
